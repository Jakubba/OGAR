...
<template>
  <Transition name="theme-confirm">
    <div
      ...
      class="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-[100] w-[min(440px,92vw)] bg-white dark:bg-[#0b1220] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/50 p-4 flex flex-col sm:flex-row sm:items-center gap-3"
    >
      ...
      <div class="flex items-center gap-2 sm:shrink-0">
        ...
        <button
          ...
          class="flex-1 sm:flex-none px-3 py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-slate-950 font-black rounded-xl hover:opacity-90 transition-all shadow-lg shadow-orange-500/20 cursor-pointer flex items-center justify-center gap-1.5 text-xs uppercase tracking-wider"
        >
